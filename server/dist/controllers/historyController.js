...
const formatAmount = (value) => `Rs ${value.toFixed(2)}`;
export const getHistoryHandler = async (req, res, next) => {
    try {
        ...
        const manufacturingRecords = typeFilter === "all" || typeFilter === "manufacturing"
            ? batches.map((batch) => ({
            ...
            : [];
        const inventoryRecords = typeFilter === "all"
            ...
            : [];
        const activityRecords = typeFilter === "all"
