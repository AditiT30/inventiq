...
const validateProductPayload = (body, isPartial = false) => {
    const requiredFields = ["product_code", "name", "weight", "price", "quantity"];
    if (!isPartial) {
...
export const getProductByCodeHandler = async (req, res, next) => {
    try {
